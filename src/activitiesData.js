export const activitiesData = {
  heritage: {
    ...
    sections: [
      {
        heading: 'Temple Renovation Projects',
        content: `Since 1998, numerous ancient temples have been renovated and consecrated under Sri Swamiji's guidance. Some notable projects include:
- Sri Kudamadumkootha Perumal Temple, Arimeya Vinnagaram (1998, 2012)
- Sri Ugra Narasimhar Temple, Thirukuraiyaloor (1999)
- Sri Parthasarathyswamy Temple, Chennai (2004, 2015)
- Sri Ranganatha Temple, Srirangam (New Kalpakavruksha Vimanam - 2018)
- Sri Pandava Dhootha Perumal Temple, Kanchipuram (2024)`
      },
      {
  ...
  veda: {
    ...
    sections: [
      {
        heading: 'Sri Sandeepani Gurukulam, Madhurapuri',
        content: 'Inaugurated in 1995, this patasala teaches Yajur and Sama Veda to 28 students. It features the Vani Pustaka Kosham library.'
      },
      {
        heading: 'Sri Premika Vedashramams',
        content: `Multiple Vedashramams operate under this initiative:
- **Srirangam:** Established 2006 near Sri Ranganatha Temple, teaching Yajur and Rig Veda to 16 vidyarthis.
- **Vedaranyam:** A Yajur Veda Patasala functioning since 2013 at the holy Shiva Kshetra.
- **Telengana:** Operating in Hyderabad since 2005 with 40 vidyarthis.`
      },
      {
        heading: 'Other Patasalas',
...
- **Shuddha Premika Vidya Kendra (Senganoor):** Imparts knowledge of the Divine Works of Sri Sri Krishna Premi Maharaj.`
  ...
  animal: {
    ...
    sections: [
      {
        heading: 'Go Samrakshana (Cow Protection)',
        content: `Three Goshalas are dedicated for Cow protection in rural Tamil Nadu:
1) Sri Gokulam Goshala, Madhurapuri Ashram (82 cows and calves).
2) Mahatma Sri Sri Krishnapremi Swamigal Pasumadam, Senganoor (57 cows and calves).
3) Goshala at Thirunangur.
Regular animal welfare camps rescue and support hundreds of cows.`
      },
      {
  ...
  health: {
    ...
    sections: [
      {
        heading: 'Free Medical Centres (Oushadalayas)',
        content: `1) Sri Premika Varadan Oushadalaya (Madhurapuri Ashram) - run by SRM Medical Institute.
2) Sri Bhagavan Nama Bodhendral Oushadalaya (Govindapuram).
3) Mahatma Sri Sri Krishnapremi Swamigal Oushadalaya (Senganoor).
Regular medical camps, eye screening, and blood donation drives are conducted.`
      },
      {
  ...
  annadaanam: {
    ...
    sections: [
      {
        heading: 'Prasada Koodams',
        content: `Major daily Annadaanam centers include:
- Sri Sridhara Ayyaval Annadhaanakoodam, Madhurapuri Ashram
...
- Sri Parvathi Ammal Prasada Koodam, Ambi Illam, Senganoor Village`
  ...
  model: {
    ...
    sections: [
      {
        heading: 'Senganoor & Kalattipet',
        content: 'In 2022, Sri Swamiji initiated the Model Village program. These villages function with banking facilities, educational coaching centres, medical centres, well-planned waste management, animal welfare shelters, fitness gyms, and value-based education.'
      },
      {
